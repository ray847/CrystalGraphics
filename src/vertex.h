...
struct Vertex {
  ...
  alignas(8) glm::vec2 tex_coord0{ 0.0f, 0.0f };
  alignas(8) glm::vec2 tex_coord1{ 0.0f, 0.0f };
};

static_assert(alignof(Vertex) == 16);
static_assert(offsetof(Vertex, position) == 0);
static_assert(offsetof(Vertex, normal) == 16);
static_assert(offsetof(Vertex, tex_coord0) == 32);
static_assert(offsetof(Vertex, tex_coord1) == 40);
